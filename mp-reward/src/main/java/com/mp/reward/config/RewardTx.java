...
/**
 * {@code db_reward} 的事务边界。业务代码只用本注解，不用裸 {@code @Transactional}。
 *
 ...
 *
 * <p><b>本注解当前尚无使用方</b>，使用方是V2 PR-3 的 RewardTxService。四库各备一个组合注解是有意的
...
@Inherited
@Documented
@Transactional(transactionManager = "rewardTransactionManager", rollbackFor = Exception.class)
public @interface RewardTx {}
